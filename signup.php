		...
		<div class="row">
				...
				<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="name" name="name" placeholder="Enter your FullName" value="" required="">
					...
					<div class="form-group">
						...
						<div class="input-group">
							<div class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></div>
							<input type="password" class="form-control" id="" name="pass2" placeholder="Confirm Password" value="" required="">
					...
					<p>Already have an account,  <i class="glyphicon glyphicon-hand-right"></i> <a href="index.php">Login here</a></p>
